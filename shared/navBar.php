        ...
        <div class="modal-content p-4" style="background-color:#fff;">
            ...
            <div id="div-forms">
                ...
                <div id="login-form">
                    <form name="login-formx" id="login-formx" action="script/verificarUsuario.php" method="post">
                        <div class="modal-body">
                            ...
                            <input autocomplete="username" onkeyup="return forceLower(this);" style="margin-top: 0" name="correo" id="login_username" class="form-control" type="email" placeholder="Correo" required>
                            <input autocomplete="current-password" name="contrasena" id="login_password" class="form-control" type="password" placeholder="Contraseña" required>
                        </div>
                        <div class="text-center">
                            <button type="submit" style="border:2px solid red;margin-bottom: 10px;" class="btn btn-danger text-center">INICIAR SESIÓN
                            </button><br>
                            <button id="login_register_btn" type="button" style="border:2px solid #fce024;" class="btn  btn-warning text-center">REGISTRARSE
                            </button><br>
                            <button style="font-size:10px" id="login_lost_btn" type="button" class="btn btn-link text-center">Olvidaste
                                tu contraseña?
                            </button>
                        </div>
                ...
                <form method="post" id="lost-form" action="script/passwordRecovery.php" style="display:none;">
                    <div class="modal-body">
                        <input onkeyup="return forceLower(this);" name="lostEmail" id="lost_email" class="form-control" type="text" placeholder="Escribe tu email." required>
                    </div>
                ...
                <div name="register-form" id="register-form" style="display:none;">
                    <form name="register-formx" id="register-formx" action="script/registerCustomer.php" method="post">
                        ...
                        <div id="registerx" class="modal-body removeArrows">
                            <input name="nombre" id="ee_register_user" class="form-control" type="text" placeholder="Tu Nombre" required>
                            <input name="apellido" id="ee_register_user" class="form-control" type="text" placeholder="Tu Apellido" required>
                            <input autocomplete="username" onkeyup="return forceLower(this);" name="correo" id="ee_register_email" class="form-control" type="email" placeholder="E-Mail" required>
                            <input name="celular" id="ee_register_number" class="form-control" type="number" onkeypress="return isNumberKey(event)" placeholder="Número Fijo/Celular de Referencia" required>
                            <input autocomplete="new-password" name="password" id="ee_register_password" class="form-control" type="password" placeholder="Contraseña" required>
                            <input autocomplete="new-password" name="ee_register_password2" id="ee_register_password2" class="form-control" type="password" placeholder="Repetir Contraseña" required>
...
<div class="fixed-top animated fadeIn faster">
    ...
    <nav class="navbar  navbar-expand-lg navbar-dark bg-transparent p-0">
        ...
        <a href="javascript:;" onclick="openAddressSelectorModal()" class="p-2 d-block d-sm-block d-md-block d-lg-none d-xl-none">
            <img style="width: 50px; height: 50px" src="assets/img/icons/icono-de-ubicacion.png" alt="">
        </a>
        <a onclick="mostrarLoading()" href="egipcio-pago.php" class="p-2 d-block d-sm-block d-md-block d-lg-none d-xl-none">
        ...
        <?php if (!isset($_SESSION['current_customer_idCliente'], $_SESSION['current_customer_email'])) { ?>
            ...
            <div class="p-2 d-block d-sm-block d-md-block d-lg-none d-xl-none">
                <a href="javascript:;" data-toggle="modal" data-target="#login-modal" class="btn bg-egipcio-yellow text-egipcio">
        ...
        ?>
            <div class="btn-group dropleft">
                <a href="" class="p-2 d-block d-sm-block d-md-block d-lg-none d-xl-none dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img style="width: 50px; height: 50px" src="assets/img/navbar/usuario.png" alt="">
                </a>
        ...
        <div class="collapse navbar-collapse" id="navbarColor03">
            <ul class="navbar-nav navbar-center mx-auto">
                ...
                <li class="nav-item ml-2">
                    <a class="nav-link <?php echo ($page == 'promociones') ? "link-activo" : ""; ?>" href="egipcio-combos.php">PROMOCIONES</a>
                </li>
                <li class="nav-item ml-2">
                    <a class="nav-link <?php echo ($page == 'categoria') ? "link-activo" : ""; ?>" href="egipcio-carta-categoria.php">CARTA</a>
                </li>
                <li class="nav-item ml-2">
                    <a class="nav-link <?php echo ($page == 'reparto') ? "link-activo" : ""; ?>" href="egipcio-reparto.php">REPARTO</a>
                </li>
                <li class="nav-item ml-2">
                    <a class="nav-link <?php echo ($page == 'contacto') ? "link-activo" : ""; ?>" href="egipcio-contacto.php">CONTACTO</a>
                </li>
