...
if (isset($_REQUEST['action']) && !empty($_REQUEST['action'])) {
    ...
    if ($_REQUEST['action'] == 'addToCart' && !empty($_REQUEST['id'])) {
        ...
        if ($cantidad > 0) {
            ...
            $redirectLoc = $insertItem ? '../egipcio-carta-categoria.php' : '../index.php';
        ...
        if ($_REQUEST['qty'] == 0) {
            ...
            header("Location: ../egipcio-carta-categoria.php");
            exit();
        }
        ...
        $redirectLoc = $updateItem ? '../egipcio-carta-categoria.php' : '../index.php';
        header("Location: " . $redirectLoc);
