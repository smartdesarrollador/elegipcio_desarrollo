...
if ($zona_tienda == '3') {
    require_once __DIR__ . '/keys_san_miguel.php';
...
<body>
    ...
    <?php } ?>
    <div class="container border rounded  mb-5 p-5">
        <div class="row mb-3">
            <div class="col">
               ...
               <!-- <div class="row mt-4">
                ...
                <div class="row mt-4 mb-4">
                    <div class="col text-center">
                        <a href="javascript:;" id="btnVerificar" class="btn btn-lg btn-danger  slow btn-seguirComprando">Verificar Datos</a>
                    </div>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <center>
            <div class="modal-dialog" role="document">
                <div class="modal-content-izipay" style="width:300px;">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel"><img src="assets/img/navbar/logo.png" style="width:50px;color: #9C0001;"> El Egipcio</h5>
