...
<body onload="ValidateModalBody(event)">
            ...
            <div class="col-12 col-sm-12 col-md-9 col-xl-9 col-lg-9">
                ...
                <div class="row mt-5 mb-4">
                    <div class="col text-center text-xl-left text-lg-left">
                        <a class="btn btn-lg btn-danger animated infinite bounce slow btn-seguirComprando" href="egipcio-carta-categoria.php">
                            Seguir comprando
                        </a>
                    </div>
                </div>
                ...
                <div class="row mt-5">
                    <div class="col text-center text-xl-left text-lg-left">
                        ...
                        ?>
                                ...
                                ?>
                                    <a onclick="pedidoMinimoAdvertencio()" class="btn btn-lg btn-danger  slow btn-seguirComprando">
                                        PAGAR
                                    </a>
                                <?php
                                } else {
                                ?>
                                    <a onclick="goToCheckout()" class="btn btn-lg btn-danger  slow btn-seguirComprando">
                                        PAGAR
                                    </a>
                            ...
                            <?php } else {
                            ?>
                                <a class="btn btn-lg btn-danger slow btn-seguirComprando" href="" data-toggle="modal" data-target="#login-modal">
                                    Pedir
                                </a>
    ...
    <script>
        ...
        let dataContainerSanMiguel = document.getElementById('ContainerSanMiguel');
        ...
        function renderData(storeId) {
            ...
            if (storeId === 3) {
                dataContainerSanMiguel.innerHTML += objectToSanMiguel();
            } else {
                dataContainerSanMiguel.innerHTML += objectToLocales();
            }
        }
        ...
        function objectToSanMiguel() {
            let horario = '<h3 class="mensaje_delivery">Nuestro Delivery Web atiende de Lunes a Sábado de 5:30 pm a 10:40 pm</h3>';
console.log("san miguel");
            return horario;
        }

        function objectToLocales() {
            let horario = '<h3 class="mensaje_delivery">Nuestro Delivery Web atiende de Lunes a Sábado de 12:30 pm a 9:00 pm</h3>';
console.log("lince");
            return horario;
        }
